        ...
        itemBuilder: (BuildContext context, int index) {
          return GestureDetector(
            ...
            child: Card(
                ...
                elevation: 3.0,
                color: _randomColor.randomColor(colorHue: ColorHue.multiple(colorHues: [ColorHue.orange, ColorHue.yellow])),
                semanticContainer: true,
                child: Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Text('Articulo nombre $index', style: TextStyle(color: Colors.white),),
                )),
          );
...
class _ArticleReaderState extends State<ArticleReader> {
  ...
  Widget build(BuildContext context) {
    ...
    if(index == 1) {
      return Container(
        color: Colors.white,
          child: Image.asset('assets/tiposcerveza.png'));
    }
    else {
      return Container(
        color: Colors.white,
          child: Image.asset('assets/colorescerveza.jpg'));
    }
  }
}
