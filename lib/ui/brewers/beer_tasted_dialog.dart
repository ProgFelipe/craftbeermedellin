              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Visibility(
                        visible:
                        widget.selectedBeer.history.isNotEmpty,
                        child: FlatButton.icon(
                          onPressed: () =>
                              _showBeerHistory(widget.selectedBeer.name,  widget.selectedBeer.history),
                          icon: Icon(
                            Icons.history,
                            color: Colors.white,
                          ),
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        ...
                        FlatButton(
                          onPressed: () {
                            widget.onTastedMark(_tasted, _vote, _comment);
                            Navigator.of(context).pop(); // To close the dialog
                          },
