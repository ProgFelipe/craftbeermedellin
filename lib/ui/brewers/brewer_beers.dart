          ...
          children: <Widget>[
            GridView.builder(
              ...
              itemBuilder: (context, index) {
                var beer = brewerData.currentBrewer.beers[index];
                    ...
                    children: [
                      Column(
                        ...
                        children: <Widget>[
                          ...
                          beerPropertiesText(
                              S.of(context).ibu, brewerData.currentBrewer.beers[index].ibu),
                          beerPropertiesText(
                              S.of(context).abv, brewerData.currentBrewer.beers[index].abv),
                          beerPropertiesText(
                              S.of(context).srm, brewerData.currentBrewer.beers[index].srm),
                          Text(
                          ...
                          StarRating(
                            rating: brewerData.currentBrewer.beers[index].ranking.toDouble(),
                          ),
                        ],
                      ),
